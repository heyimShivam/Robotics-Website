      ...
      <div id='home'>
        ...
        <div className='backshadow'>
          <div class='frontlook'>
            ...
            <div id='stars2' />
            <div id='stars3' />
            <div className='col robot-homepage'>
                <svg class="robot-on-homepage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 197.60004 221.93357">
      {/* <g id="Big-Bg">
        <path
          id="Bg-1"
        ...
        <g className="robot-head">
          ...
          <g className="robot-eyes">
            ...
            <rect
              ...
              rx="10px"
            />
            <circle cx={79} cy="61.15167" r={3} fill="black" />
            <circle cx={102} cy="61.15167" r={3} fill="black" />
          </g>
        </g>
      </g>
    </svg> 
